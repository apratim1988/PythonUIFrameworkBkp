...
from TestCases_AR.BaseTest import BaseTest
from Utilities import dataProvider

class Test_RSA_TW(BaseTest):


    @pytest.mark.parametrize("model,RTO,expdate,mobileno,fullname,email,regno,engno,chssno,finname,pucno,pucexpdt,prevpolno,nomname,nomage,pan,aadhar,add1,add2,pin", dataProvider.get_data("rsa_twowheeler"))
    def test_RSA_TW(self,model,RTO,expdate,mobileno,fullname,email,regno,engno,chssno,finname,pucno,pucexpdt,prevpolno,nomname,nomage,pan,aadhar,add1,add2,pin):
        ...
        rsatwselectvehiclepage.SelectVehicleBrand()
        time.sleep(2)
